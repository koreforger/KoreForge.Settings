...
// Register KoreForge Settings with live SQL Server reload
builder.Configuration.AddKoreForgeSettings(opts =>
{
    opts.ApplicationId = "koreforge-settings-sample";
...
app.MapGet("/settings/{key}/history", async (string key, IHistoryService svc, ISettingsService settingsSvc, KoreForgeSettingsOptions opts, CancellationToken ct) =>
{
