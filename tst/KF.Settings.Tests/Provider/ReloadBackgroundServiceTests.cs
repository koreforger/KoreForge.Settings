...
{
    private static (SettingsReloadBackgroundService svc, KFSettingsConfigurationProvider provider, InMemoryDbContextFactory factory, TestMetricsRecorder metrics, HealthReporter health) Build(
        ...
        string? clientAppVersion = null)
    {
        ...
        var opts = new KFSettingsOptions { ApplicationId = appId, InstanceId = instanceId, ClientAppVersion = clientAppVersion, PollingInterval = TimeSpan.FromMilliseconds(150), EnableMetrics = true };
