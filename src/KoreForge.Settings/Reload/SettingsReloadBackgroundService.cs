...
public sealed class SettingsReloadBackgroundService : BackgroundService
{
    ...
    private readonly IDbContextFactory<KoreForgeSettingsDbContext> _dbFactory;
    private readonly KoreForgeSettingsOptions _options;
    private readonly KoreForgeSettingsConfigurationProvider _provider;
    ...
    public SettingsReloadBackgroundService(
        ...
        IDbContextFactory<KoreForgeSettingsDbContext> dbFactory,
        KoreForgeSettingsOptions options,
        KoreForgeSettingsConfigurationProvider provider,
