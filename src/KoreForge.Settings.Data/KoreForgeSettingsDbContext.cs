...
namespace KoreForge.Settings.Data;

public class KoreForgeSettingsDbContext : DbContext
{
    public DbSet<SettingEntity> Settings => Set<SettingEntity>();
    public DbSet<SettingsHistoryEntity> SettingsHistory => Set<SettingsHistoryEntity>();

    public KoreForgeSettingsDbContext(DbContextOptions<KoreForgeSettingsDbContext> options) : base(options) { }
