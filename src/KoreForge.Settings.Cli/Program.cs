...
RootServices BuildServicesInternal(InvocationContext ctx)
{
    ...
    var opts = new KoreForgeSettingsOptions { ApplicationId = app, InstanceId = inst, ClientAppVersion = clientVer, ConnectionString = conn };
...
readonly record struct RootServices(IServiceProvider Provider, KoreForgeSettingsOptions Options);
