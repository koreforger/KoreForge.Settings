...
public sealed class SettingsService : ISettingsService
{
    ...
    public SettingsService(IDbContextFactory<KoreForgeSettingsDbContext> factory, IMetricsRecorder metrics, ISystemClock clock)
    ...
    private async Task<SettingRow> UpsertSqlServerAsync(KoreForgeSettingsDbContext db, SettingUpsert request, CancellationToken ct)
    {
        while (true)
        {
